...
$(document).ready(function(){
	...
	$("#pushBtn").click(function(){
		...
		//send($("#content").val(),$("#title").val());
		
		var bodyMessage = $("#bodycontent").val();
		var titleMessage =$("#title").val();
		
		sendMessage(bodyMessage, titleMessage);
	});
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            푸쉬 알림 전송하기</h1>
			   ...
			   <form method="post" id="pushMessage" action="${pageCotext.request.contextPath}/admin/send" >
			  <div>
		  		
			    <div class="form-group col-md-2">
			      <label for="inputEmail4">제목</label>
			      <input type="text" id ="title" class="form-control" name="titleMessage">
			    </div>
			    
			    <div class="form-group col-md-2">
			      <label for="inputEmail4">내용</label>
			      <input type="text" id= "bodycontent" class="form-control" name="bodyMessage">
			    </div>
			  ...
			  <button id="pushBtn" class="btn btn-primary">전송</button>
