...
$(document).ready(function(){
	...
	function changeState(id) {  
	    ...
	    $.ajax({
	        type : 'GET',
	        url : "/admin/changeCallingPlanSate",
	        data : {"id" : id},
						...
						<div class="card-body">
							<div class="table-responsive">
										...
										<table class="table table-bordered" id="dataTable"
											...
											<tbody>
												<c:forEach items="${callingPlan}" var="callingPlan">
													<tr>
														<td>${callingPlan.callingPlanId}</td>
														...
														<c:choose>
															<c:when test="${callingPlan.state==1}">
																<td style="color: green;"><a href="#"
																	...
																	id="${callingPlan.callingPlanId}"> <span
																		class="text">활성화</span>
																</a>
															</c:when>
														...
														<td style="color: green;"><a
															href="${pageContext.request.contextPath}/admin/callingPlanDetail/${callingPlan.callingPlanId}"
															class="btn btn-primary" id="${callingPlan.callingPlanId}">
								...
								<div class="form-group col-md-2">
									<button type="button"
										onclick="location.href='${pageContext.request.contextPath}/admin/callingPlanRegister'"
										class="btn btn-primary">요금제 등록하기</button>
								</div>
							</div>
						</div>
					</div>
