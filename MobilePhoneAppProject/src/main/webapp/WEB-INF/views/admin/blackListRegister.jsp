        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            지점 등록하기</h1>
			   ...
			   <form method="post" id="blackListForm" action="${pageCotext.request.contextPath}/admin/blackListForm" >
			  <div>
			    ...
			    <div class="form-group col-md-2">
			      ...
			      <label for="inputEmail4">메모</label> 
			  ...
			  <button type="submit" id="registerBlackList" class="btn btn-primary">등록</button>
			  </div>
			  </form>
