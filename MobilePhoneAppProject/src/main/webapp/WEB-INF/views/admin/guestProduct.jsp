						...
						<div class="card-body">
							<div class="table-responsive">
										...
										<table class="table table-bordered" id="dataTable"
											...
											<tbody>
												<c:forEach items="${guestProduct}" var="guestProduct">
													<tr>
														<td>${guestProduct.guestProductId}</td>
														...
														<td style="color: green;"><a
															href="${pageContext.request.contextPath}/admin/guestProductDetail/${guestProduct.guestProductId}"
															class="btn btn-primary"
															id="${guestProduct.guestProductId}"> <span
																class="text">수정</span>
														</a>
								...
								<div class="form-group col-md-2">
									<button type="button"
										onclick="location.href='${pageContext.request.contextPath}/admin/guestProductRegister'"
