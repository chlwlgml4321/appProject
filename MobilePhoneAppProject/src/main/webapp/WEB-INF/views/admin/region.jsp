						...
						<div class="card-body">
							<div class="table-responsive">
												...
												<c:forEach items="${region}" var="region">
													<tr>
														...
														<td style="color: green;"><a
															href="${pageContext.request.contextPath}/admin/regionDetail/${region.regionId}"
															class="btn btn-warning" id="${region.regionId}"> <span
																class="text">수정</span>
														</a>
								...
								<div class="form-group col-md-2">
									<button type="button"
										onclick="location.href='${pageContext.request.contextPath}/admin/regionInsert'"
										class="btn btn-primary">지역 등록하기</button>
								</div>
							</div>
						</div>
					</div>
