						...
						<div class="card-body">
							<div class="table-responsive">
										...
										<table class="table table-bordered" id="dataTable"
											...
											<tbody>
												<c:forEach items="${wiredGoods}" var="wg">
													<tr>
														<td>${wg.wiredGoodsId}</td>

														<td><img src="${wg.wiredGoodsImg}" width="100px"
															height="110px"></td>
														...
														<c:choose>
															<c:when test="${wg.state==1}">
																<td style="color: green;"><a href="#"
																	class="btn btn-success" id="${wg.wiredGoodsId}"> <span
																		class="text">활성화</span>
																</a>
															</c:when>
															...
															<c:otherwise>
																<td style="color: red;"><a href="#"
																	class="btn btn-warning" id="${wg.wiredGoodsId}"> <span
														...
														<td style="color: green;"><a
															href="${pageContext.request.contextPath}/admin/wiredGoodsDetail/${wg.wiredGoodsId}"
															class="btn btn-primary" id="${wg.wiredGoodsId}"> <span
																class="text">수정</span>
								...
								<div class="form-group col-md-2">
									<button type="button"
										onclick="location.href='${pageContext.request.contextPath}/admin/wiredGoodsRegister'"
										class="btn btn-primary">유선상품 등록하기</button>
								</div>
							</div>
						</div>
					</div>
