						...
						<div class="card-body">
							<div class="table-responsive">
											...
											<tbody>
												<c:forEach items="${blackList}" var="blackList">
													<tr>
														...
														<td>${blackList.regDate}</td>

														
														<td style="color: green;"><a href="#"
															class="btn btn-success" id="${blackList.blacklistId}"> <span
																class="text">삭제</span>
														</a>
													</tr>
												</c:forEach>
								...
								<div class="form-group col-md-2">
									<button type="button"
										onclick="location.href='${pageContext.request.contextPath}/admin/blackListRegister'"
										class="btn btn-primary">블랙리스트 추가하기</button>
								</div>
							</div>
						</div>
					</div>
