				...
				<div class="container-fluid">
					...
					<form method="post" id="wiredGoodsForm" enctype="multipart/form-data"
						...
						<div>
							...
							<input type='hidden' name='wiredGoodsId'
								value="${wiredGoods.wiredGoodsId}">
							...
							<div class="form-group col-md-2">
								<label for="inputEmail4">유선상품 이름</label> <input type="text"
									class="form-control" id="wiredGoodsName" name="wiredGoodsName">
							</div>
							...
							<div class="form-group col-md-2">
								<label for="inputEmail4">용량</label> <input type="text"
									class="form-control" id="capacity" placeholder=" "
									name="capacity">
							</div>

							<div class="form-group col-md-2">
								<label for="inputEmail4">회선</label> <input type="text"
									class="form-control" id="circuit" placeholder="" name="circuit">
							</div>

							<div class="form-group col-md-2">
								<label for="inputEmail4">요금</label> <input type="text"
									class="form-control" id="fee" placeholder="" name="fee">
							</div>
