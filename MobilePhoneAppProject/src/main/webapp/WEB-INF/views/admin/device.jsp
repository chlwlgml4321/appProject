						...
						<div class="card-body">
							<div class="table-responsive">
												...
												<c:forEach items="${device}" var="device">
													<tr>
														...
														<c:choose>
															<c:when test="${device.state==1}">
																<td style="color: green;"><a href="#"
																	class="btn btn-success" id="${device.deviceId}"> <span
																		class="text">활성화</span>
																</a>
															</c:when>
															...
															<c:otherwise>
																<td style="color: red;"><a href="#"
																	class="btn btn-warning" id="${device.deviceId}"> <span
														...
														<td style="color: green;"><a
															href="${pageContext.request.contextPath}/admin/deviceDetail/${device.deviceId}"
								...
								<div class="form-group col-md-2">
									<button type="button"
										onclick="location.href='${pageContext.request.contextPath}/admin/deviceRegister'"
										class="btn btn-primary">디바이스 등록</button>
								</div>
							</div>
						</div>
					</div>
