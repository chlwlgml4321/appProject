	                    ...
	                    <tr>
	                      ...
	                      <c:choose>
	  					 	<c:when test="${device.state==1}">
	  					 		...
	  					 		<a href="#" class="btn btn-success" id="${device.deviceId}">
	  					 	...
	  					 	<c:otherwise>
	  					 		<td style="color: red;">
	  					 		<a href="#" class="btn btn-warning" id= "${device.deviceId}">
	  					  ...
	  					  <td style="color: green;">
	  					 		<a href="${pageContext.request.contextPath}/deviceDetail/${device.deviceId}"  class="btn btn-primary"  id="${device.deviceId}">
                						...
                						<div class="form-group col-md-2">
											<button type="button" onclick="location.href='${pageContext.request.contextPath}/deviceRegister'" class="btn btn-primary">디바이스 등록</button>
										</div>
              </div>
            </div>
          </div>
