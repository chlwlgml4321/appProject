						...
						<div class="card-body">
							<div class="table-responsive">
												...
												<c:forEach items="${products}" var="products">
													<tr>
														...
														<c:choose>
															<c:when test="${products.state==1}">
																<td style="color: green;"><a href="#"
																	class="btn btn-success" id="${products.productsId}">
															...
															<c:otherwise>
																<td style="color: red;"><a href="#"
																	class="btn btn-warning" id="${products.productsId}">
														...
														<td style="color: green;"><a
															href="${pageContext.request.contextPath}/common/productDetail/${products.productsId}"
															class="btn btn-primary" id="${products.productsId}">
								...
								<div class="form-group col-md-2">
									<button type="button"
										onclick="location.href='${pageContext.request.contextPath}/common/productRegister'"
