		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<form method="post" id="callingPlanForm"
						action="${pageCotext.request.contextPath}/admin/callingPlanForm">
						<div>

							<input type='hidden' name='callingPlanId'
							...
							<div class="form-group col-md-2">
								<label for="inputEmail4">요금제 이름</label> <input type="text"
									class="form-control" id="planName" name="planName">
							</div>

							<div class="form-group col-md-2">
								<label for="inputEmail4">기본요금</label> <input type="text"
									class="form-control" id="basicFee" name="basicFee">
							</div>


							<div class="form-group col-md-2">
								<label for="inputEmail4">선택약정 할인율</label> <input type="text"
							...
							<div class="form-group col-md-2">
								<label for="inputEmail4">networkType</label> <select
									id="networkType" class="form-control" name="networkType">
						...
						<div class="form-group col-md-2">
							<button type="submit" id="registerCallingPlan"
